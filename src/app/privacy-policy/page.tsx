export default function PrivacyPolicy() {
  return (
    <div className="max-w-screen-md mx-auto px-8 py-6 bg-white rounded-lg shadow-md flex flex-col gap-4">
      <h1 className="text-2xl font-bold">Privacy Policy</h1>
      <p className="text-sm text-gray-500">Last updated: February 23, 2025</p>
      <p className="text-sm">
      ...
      <h3 className="text-base font-bold">Interpretation</h3>
      <p className="text-sm">
      ...
      <h3 className="text-base font-bold">Definitions</h3>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to DataDock.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to DataDock, accessible from{" "}
            <a
              href="datadock.live"
      ...
      <h3 className="text-base font-bold">Types of Data Collected</h3>
      ...
      <h4 className="text-base font-bold">Tracking Technologies and Cookies</h4>
      <p className="text-sm">
      ...
      <h3 className="text-base font-bold">Use of Your Personal Data</h3>
      <p className="text-sm">
      ...
      <h3 className="text-base font-bold">Retention of Your Personal Data</h3>
      <p className="text-sm">
      ...
      <h3 className="text-base font-bold">Transfer of Your Personal Data</h3>
      <p className="text-sm">
      ...
      <h3 className="text-base font-bold">Delete Your Personal Data</h3>
      <p className="text-sm">
      ...
      <h3 className="text-base font-bold">Disclosure of Your Personal Data</h3>
      <h4 className="text-base font-bold">Business Transactions</h4>
      <p className="text-sm">
      ...
      <h4 className="text-base font-bold">Law enforcement</h4>
      <p className="text-sm">
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="text-base font-bold">Other legal requirements</h4>
      <p className="text-sm">
      ...
      <h3 className="text-base font-bold">Security of Your Personal Data</h3>
      <p className="text-sm">
      ...
      <h2 className="text-base font-bold">Changes to this Privacy Policy</h2>
      <p className="text-sm">
      ...
      <ul>
        <li>By email: mohammedgaber273@gmail.com</li>
      </ul>
    </div>
  );
}
